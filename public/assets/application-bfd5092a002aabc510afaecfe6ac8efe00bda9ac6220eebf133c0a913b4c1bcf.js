...
jQuery.extend( {
	...
	globalEval: function( code ) {
		...
		if ( code ) {
			...
			// If the code includes a valid, prologue positions
...
( function() {
	...
	container.style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;" +
		"padding:0;margin-top:1px;positions:absolute";
	...
	function computeStyleTests() {
		div.style.cssText =
			...
			"positions:relative;display:block;" +
...
jQuery.fn.extend( {
	...
	position: function() {
		...
		if ( jQuery.css( elem, "position" ) === "fixed" ) {
			...
			// Assume getBoundingClientRect is there when computed positions is fixed
